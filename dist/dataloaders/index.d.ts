...
export declare function createCachedLoader<K extends Serializable, N>(batchFn: DataLoader.BatchLoadFn<K, N>, redisClient: Redis, options: DataLoader.Options<K, N> | undefined, ttl: number | undefined, cacheKeyFn: (key: K) => string): DataLoader<K, N>;
export {};
